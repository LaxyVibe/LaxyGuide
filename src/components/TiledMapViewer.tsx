...
const TiledMapViewer = React.forwardRef<MapViewerHandle, TiledMapViewerProps>(
    (
        ...
        const normalizedPoiRegions = useMemo(
            () => buildNormalizedPoiRegions(pins, {
                mapPixelWidth,
                mapPixelHeight,
                mapTileMaxZoom
            }),
        ...
        return (
            <div style={{ position: 'relative', width: '100%', height: '100%', overflow: 'hidden' }}>
                ...
                >
                    ...
                    {ready && traversableRegions.length === 0 && traversableRegionsNormalized
